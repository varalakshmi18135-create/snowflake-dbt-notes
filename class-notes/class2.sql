...
UPDATE COLLEGE.MITS.STUDENT

SET GENDER= 'FEMALE' WHERE MARKS IN (95,90);

CREATE OR REPLACE TABLE COLLEGE.SGMS.STUDENT( SID INT,NAME STRING, ADDRESS STRING,PHONE INT,MARKS INT);


ALTER TABLE COLLEGE.MITS.STUDENT ADD COLUMN GENDER STRING;



    INSERT INTO COLLEGE.SGMS.STUDENT (SID, NAME, ADDRESS, PHONE, MARKS)
VALUES 
    (101, 'Ananya Sharma', 'Hyderabad', 9876543210, 88),
    (102, 'Rohan Verma', 'Bangalore', 9123456789, 92),
    (103, 'Priya Nair', 'Chennai', 9012345678, 75),
    (104, 'Rahul Das', 'Kolkata', 9988776655, 95),
    (105, 'Sneha Reddy', 'Vijayawada', 9848012345, 81),
    (106, 'Vikram Singh', 'Delhi', 9711223344, 68),
    (107, 'Kavya Patel', 'Ahmedabad', 9654321098, 90),
    (108, 'Arjun Mehta', 'Mumbai', 9543210987, 84),
    (109, 'Pooja Joshi', 'Pune', 9432109876, 79),
    (110, 'Suresh Kumar', 'Kochi', 9321098765, 87),
    (111, 'Neha Gupta', 'Jaipur', 9210987654, 91),
    (112, 'Aditya Rao', 'Visakhapatnam', 9109876543, 73),
    (113, 'Divya Pillai', 'Trivandrum', 9098765432, 86),
    (114, 'Manoj Tiwari', 'Lucknow', 8987654321, 64),
    (115, 'Shreya Iyer', 'Coimbatore', 8876543210, 93),
    (116, 'Karan Malhotra', 'Chandigarh', 8765432109, 78),
    (117, 'Ritu Sen', 'Guwahati', 8654321098, 82),
    (118, 'Nikhil Kulkarni', 'Nagpur', 8543210987, 89),
    (119, 'Bhavna Mishra', 'Bhopal', 8432109876, 71),
    (120, 'Tarun Bhatia', 'Indore', 8321098765, 96);



SELECT * FROM COLLEGE.SGMS.STUDENT;

ALTER TABLE COLLEGE.SGMS.STUDENT ADD COLUMN GENDER STRING;

ALTER TABLE COLLEGE.SGMS.STUDENT DROP COLUMN GENDER;

UPDATE  COLLEGE.SGMS.STUDENT SET GENDER= 'FEMALE' WHERE MARKS IN (  75);

ALTER TABLE COLLEGE.SGMS.STUDENT DROP COLUMN GENDER;

SELECT * FROM COLLEGE.SGMS.STUDENT;

SELECT COUNT(*) FROM COLLEGE.SGMS.STUDENT;

CREATE OR REPLACE TABLE COLLEGE.vit.STUDENT( SID INT,NAME STRING, ADDRESS STRING,PHONE INT,MARKS INT);

INSERT INTO COLLEGE.vit.STUDENT (SID, NAME, ADDRESS, PHONE, MARKS) values

INSERT INTO COLLEGE.vit.STUDENT (SID, NAME, ADDRESS, PHONE, MARKS) VALUES
(101, 'Aarav Sharma', 'Delhi', 9876543210, 85),
(102, 'Ananya Iyer', 'Chennai', 9876543211, 92),
(103, 'Rohan Mehta', 'Mumbai', 9876543212, 78),
(104, 'Priya Nair', 'Kochi', 9876543213, 88),
(105, 'Vikram Patel', 'Ahmedabad', 9876543214, 65),
(106, 'Sneha Reddy', 'Hyderabad', 9876543215, 94),
(107, 'Rahul Das', 'Kolkata', 9876543216, 72),
(108, 'Kavya Rao', 'Bengaluru', 9876543217, 89),
(109, 'Arjun Singh', 'Jaipur', 9876543218, 81),
(110, 'Neha Gupta', 'Lucknow', 9876543219, 90),
(111, 'Siddharth Joshi', 'Pune', 9876543220, 76),
(112, 'Pooja Bhatia', 'Indore', 9876543221, 83),
(113, 'Aditya Kumar', 'Patna', 9876543222, 69),
(114, 'Diya Sen', 'Guwahati', 9876543223, 95),
(115, 'Karan Malhotra', 'Chandigarh', 9876543224, 74),
(116, 'Ritu Kulkarni', 'Nagpur', 9876543225, 87),
(117, 'Manish Tiwari', 'Varanasi', 9876543226, 62),
(118, 'Shreya Mishra', 'Bhopal', 9876543227, 91),
(119, 'Nikhil Verma', 'Surat', 9876543228, 79),
(120, 'Bhavna Pillai', 'Trivandrum', 9876543229, 86),
(121, 'Tarun Agarwal', 'Agra', 9876543230, 70),
(122, 'Meera Deshmukh', 'Nashik', 9876543231, 93),
(123, 'Varun Chawla', 'Ludhiana', 9876543232, 68),
(124, 'Swati Choudhury', 'Bhubaneswar', 9876543233, 84),
(125, 'Gaurav Saxena', 'Kanpur', 9876543234, 77),
(126, 'Isha Kapoor', 'Dehradun', 9876543235, 96),
(127, 'Rishabh Pandey', 'Ranchi', 9876543236, 64),
(128, 'Tanvi Nambiar', 'Calicut', 9876543237, 82),
(129, 'Deepak Hegde', 'Mangalore', 9876543238, 73),
(130, 'Kritika Roy', 'Siliguri', 9876543239, 88);

select * from COLLEGE.vit.STUDENT;

select * from college.student;
()
select * from COLLEGE.VIT.STUDENT where name ilike '%a';
...
select * from COLLEGE.STUDENT at (offset=>-5*60);
...
SELECT 'country - ', COUNT(*) FROM countries;
